function varargout = GUI_Otkaz_N2(varargin)
% GUI_OTKAZ_N2 MATLAB code for GUI_Otkaz_N2.fig
%      GUI_OTKAZ_N2, by itself, creates a new GUI_OTKAZ_N2 or raises the existing
%      singleton*.
%
%      H = GUI_OTKAZ_N2 returns the handle to a new GUI_OTKAZ_N2 or the handle to
%      the existing singleton*.
%
%      GUI_OTKAZ_N2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_OTKAZ_N2.M with the given input arguments.
%
%      GUI_OTKAZ_N2('Property','Value',...) creates a new GUI_OTKAZ_N2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_Otkaz_N2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_Otkaz_N2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_Otkaz_N2

% Last Modified by GUIDE v2.5 06-Sep-2016 18:23:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_Otkaz_N2_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Otkaz_N2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_Otkaz_N2 is made visible.
function GUI_Otkaz_N2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_Otkaz_N2 (see VARARGIN)

% Choose default command line output for GUI_Otkaz_N2
...
% UIWAIT makes GUI_Otkaz_N2 wait for user response (see UIRESUME)
% uiwait(handles.Gui_ZAVPRBR);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_Otkaz_N2_OutputFcn(hObject, eventdata, handles) 
...
%       phi_otkz=Fkp_sr1./(Zpdo_sr1);
    ...
    case 3
        ...
        Fkp_sr2o=getappdata(0,'F_kpo');
        Fkp_sr2o(isnan( Fkp_sr2o))=0;
        Fkz_sr2o=getappdata(0,'F_kzo');
        Fkz_sr2o(isnan(Fkz_sr2o))=0;
        Fkp_sr2no=getappdata(0,'F_kpno');
        Fkp_sr2no(isnan( Fkp_sr2no))=0;
        Fkz_sr2no=getappdata(0,'F_kzno');
...
switch sw_value 
    ...
    case 2
        ...
        Fkz_sr1=getappdata(0,'F_kzo');
        Fkz_sr1(isnan(Fkz_sr1))=0;
        Fkzo=Fkz_sr1;
    case 3
              
        Fkz_sr2=getappdata(0,'F_kzo');
