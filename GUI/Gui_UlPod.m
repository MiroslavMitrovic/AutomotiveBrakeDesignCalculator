...
function varargout = Gui_UlPod(varargin)
% GUI_ULPOD MATLAB code for Gui_UlPod.fig
%      GUI_ULPOD, by itself, creates a new GUI_ULPOD or raises the existing
%      singleton*.
%
%      H = GUI_ULPOD returns the handle to a new GUI_ULPOD or the handle to
%      the existing singleton*.
%
%      GUI_ULPOD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_ULPOD.M with the given input arguments.
%
%      GUI_ULPOD('Property','Value',...) creates a new GUI_ULPOD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Gui_UlPod_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Gui_UlPod_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Gui_UlPod

% Last Modified by GUIDE v2.5 21-Dec-2014 23:03:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Gui_UlPod_OpeningFcn, ...
                   'gui_OutputFcn',  @Gui_UlPod_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Gui_UlPod is made visible.
function Gui_UlPod_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no outputfku args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Gui_UlPod (see VARARGIN)

% Choose default command line outputfku for Gui_UlPod
...
%set(handles.Gui_Ulpod, 'units', 'normalized', 'position', [0.05 0.15 0.9 0.8]) 
...
% UIWAIT makes Gui_UlPod wait for user response (see UIRESUME)
% uiwait(handles.Gui_Ulpod);


% --- Outputs from this function are returned to the command line.
function varargout = Gui_UlPod_OutputFcn(hObject, eventdata, handles) 
...
bool1 %Provera da li su vrednosti unesene
...
bool_data(isempty(bool_data))=0;%Izbacivanje empty vrednosti
