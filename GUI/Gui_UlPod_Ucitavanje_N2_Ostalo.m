...
function varargout = Gui_UlPod_Ucitavanje_N2_Ostalo(varargin)
% GUI_ULPOD_UCITAVANJE_N2_OSTALO MATLAB code for Gui_UlPod_Ucitavanje_N2_Ostalo.fig
%      GUI_ULPOD_UCITAVANJE_N2_OSTALO, by itself, creates a new GUI_ULPOD_UCITAVANJE_N2_OSTALO or raises the existing
%      singleton*.
%
%      H = GUI_ULPOD_UCITAVANJE_N2_OSTALO returns the handle to a new GUI_ULPOD_UCITAVANJE_N2_OSTALO or the handle to
%      the existing singleton*.
%
%      GUI_ULPOD_UCITAVANJE_N2_OSTALO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_ULPOD_UCITAVANJE_N2_OSTALO.M with the given input arguments.
%
%      GUI_ULPOD_UCITAVANJE_N2_OSTALO('Property','Value',...) creates a new GUI_ULPOD_UCITAVANJE_N2_OSTALO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Gui_UlPod_Ucitavanje_N2_Ostalo_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Gui_UlPod_Ucitavanje_N2_Ostalo_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Gui_UlPod_Ucitavanje_N2_Ostalo

% Last Modified by GUIDE v2.5 03-Jun-2016 11:51:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Gui_UlPod_Ucitavanje_N2_Ostalo_OpeningFcn, ...
                   'gui_OutputFcn',  @Gui_UlPod_Ucitavanje_N2_Ostalo_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Gui_UlPod_Ucitavanje_N2_Ostalo is made visible.
function Gui_UlPod_Ucitavanje_N2_Ostalo_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no outputfku args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Gui_UlPod_Ucitavanje_N2_Ostalo (see VARARGIN)

% Choose default command line outputfku for Gui_UlPod_Ucitavanje_N2_Ostalo
...
%set(handles.gui_ulpod_ucitavanje_n2_ostalo, 'units', 'normalized', 'position', [0.05 0.15 0.9 0.8]) 
...
% UIWAIT makes Gui_UlPod_Ucitavanje_N2_Ostalo wait for user response (see UIRESUME)
% uiwait(handles.gui_ulpod_ucitavanje_n2_ostalo);


% --- Outputs from this function are returned to the command line.
function varargout = Gui_UlPod_Ucitavanje_N2_Ostalo_OutputFcn(hObject, eventdata, handles) 
